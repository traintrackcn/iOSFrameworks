...
- (void)drawButtonInRect:(CGRect)rect title:(NSString *)title highlighted:(BOOL)highlighted down:(BOOL)down {
  ...
  [title drawInRect:textFrame withFont:self.titleFont lineBreakMode:NSLineBreakByTruncatingTail alignment:NSTextAlignmentCenter];
  CGContextRestoreGState(ctx);
...
- (void)drawTitleInRect:(CGRect)rect isSubtitle:(BOOL)isSubtitle {
  ...
  if (title.length > 0) {
    ...
    [title drawInRect:rect withFont:font lineBreakMode:NSLineBreakByTruncatingTail alignment:NSTextAlignmentCenter];
