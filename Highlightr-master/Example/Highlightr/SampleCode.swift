...
class SampleCode: UIViewController
{
    ...
    @IBAction func pickLanguage(_ sender: AnyObject)
    {
        ...
        let alertC = UIAlertController.init(title: "Pick a language", message: nil, preferredStyle: UIAlertControllerStyle.actionSheet);
        
        for item in languages {
            let language = item as String;
            let a = UIAlertAction.init(title: language, style: UIAlertActionStyle.default) { (action) in
...
//                                                    origin: toolBar)
    ...
    @IBAction func pickTheme(_ sender: AnyObject)
    {
        ...
        let alertC = UIAlertController.init(title: "Pick a Theme", message: nil, preferredStyle: UIAlertControllerStyle.actionSheet);
        for item in themes{
            let theme = item as String;
            let a = UIAlertAction.init(title: theme, style: UIAlertActionStyle.default) { (action) in
